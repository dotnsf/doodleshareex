...
/* rooms */
drop table rooms;
create table if not exists rooms ( id varchar(256) not null primary key, uuid varchar(100) default '', basic_id varchar(50) default '', basic_password varchar(50) default '', room_password varchar(50) default '', created bigint default 0, updated bigint default 0 );
